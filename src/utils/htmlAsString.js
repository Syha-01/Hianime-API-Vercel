export const htmlAsString = `
  ...
  <html lang="en">
        ...
        * {
        ...
        body {
          ...
          font-family:
            ...
            'Helvetica Neue',
            sans-serif;
          background: radial-gradient(1200px 600px at top, #11162a, var(--bg));
          color: var(--text);
          line-height: 1.6;
        }
    ...
    <body>
      <header>
        ...
        <p>
          ...
          <strong>hianimez.to</strong>. Built for developers who want anime data without dealing with
          scraping.
        </p>
    ...
    "data": {}
          ...
          <div class="card">
            <h2>⚠️ Disclaimer</h2>
            <p>
              This API is not affiliated with hianimez.to. All content belongs to its original owners.
            </p>
            <p>Use for <strong>educational and personal</strong> purposes only.</p>
          </div>
        </section>
        ...
        <section class="section">
          ...
          <div class="grid">
            ...
            <div class="card">
              <h2>📃 Anime List</h2>
              <p><code>GET /animes/{query}/{category}</code></p>
              <p>Popular, top airing, genre, A–Z, movies, TV, OVA.</p>
            </div>
            ...
            <div class="card">
              <h2>▶️ Streaming</h2>
              <p>
                <code>GET /stream?id=EP_ID&server=vidcloud&type=sub</code>
              </p>
  ...
  bun run dev</code></pre>
      ...
      <footer>
        <p>
          Built by
          <a href="https://github.com/yahyaMomin" target="_blank">yahyaMomin</a>
          ·
          <a href="https://github.com/yahyaMomin/hianime-API" target="_blank"> GitHub </a>
          ·
          <a href="https://github.com/yahyaMomin/watanuki" target="_blank"> Frontend Example </a>
        </p>
